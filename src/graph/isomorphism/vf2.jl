...
"""
isexactmatch(G, H; kwargs...) = !isempty(exactmatches(G, H; kwargs...))
...
"""
    edgesubgraphmatches(
        G::AbstractGraph, H::AbstractGraph; kwargs...) -> Iterator

Generate isomorphism mappings between `H` and edge-induced subgraphs of `G`.
"""
function edgesubgraphmatches(
            G::T1, H::T2;
